...
public class ContaPoupanca extends Conta implements OperacoesBancarias {
   private static final double RENDIMENTO_MENSAL = 0.003; // 0.3% de rendimento
   ...
   @Override
   public void atualizarSaldo() {
       saldo += saldo * RENDIMENTO_MENSAL;  // Aplica o rendimento de 0.3%
       System.out.println("Saldo atualizado com o rendimento de 0.3%.");
   }
